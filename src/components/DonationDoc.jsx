...
export default function DonationDoc({ receipt, id = "donation-document" }) {
  ...
  return (
    ...
    >
      ...
      {/* ══════ HEADER ══════ */}
      <div style={{ display: "flex", gap: "20px", alignItems: "center", borderBottom: "3px solid #0f766e", paddingBottom: "14px", marginBottom: "14px" }}>
        ...
        <div style={{ paddingLeft: "10px" }}>
          <h1 style={{
            margin: 0, fontSize: "1.75rem", fontWeight: "500", color: "#0f766e",
      ...
      <div style={{ textAlign: "center", marginBottom: "14px" }}>
        <h2 style={{
          margin: 0, fontSize: "1.45rem", fontWeight: "500", color: "#0f766e",
      ...
      <div style={{ border: "1.5px solid #cbd5e1", borderRadius: "8px", padding: "10px 16px", marginBottom: "12px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px dashed #cbd5e1", paddingBottom: "6px", marginBottom: "8px" }}>
          <div>
            ...
            <span style={{ fontFamily: "monospace", fontWeight: "800", fontSize: "0.84rem", color: "#0f766e" }}>{rNo}</span>
          </div>
          <div>
            <span style={{ fontWeight: "700", color: "#374151", fontSize: "0.77rem" }}>Tax Year : </span>
            <span style={{ fontWeight: "800", color: "#0f766e", fontSize: "0.77rem" }}>{rTaxYear}</span>
          </div>
          <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
          ...
          <Row label="Received with thanks from :">
            <span style={{ fontWeight: "800", color: "#0f766e", fontSize: "0.9rem" }}>{dName}</span>
          </Row>
          ...
          <Row label="In words :">
            <span style={{ fontWeight: "800", color: "#15803d", fontStyle: "italic" }}>{dWords}</span>
          </Row>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "6px", marginTop: "10px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }}>
          <div style={{ fontSize: "0.79rem", fontWeight: "800", color: "#0f766e", letterSpacing: "0.4px", paddingTop: "4px" }}>Registration Details</div>
          <div style={{ fontSize: "0.79rem", fontWeight: "800", color: "#0f766e", letterSpacing: "0.4px", paddingTop: "4px" }}>Bank Account Details</div>
        </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", border: "1.5px solid #94a3b8", fontSize: "0.66rem" }}>
            <tbody>
              {credRows.map(([label, val]) => (
                <tr key={label}>
                  <td style={{ padding: "3px 6px", border: "1px solid #cbd5e1", fontWeight: "700", background: "#f8fafc", color: "#374151", width: "35%" }}>{label}</td>
                  <td style={{ padding: "3px 6px", border: "1px solid #cbd5e1", fontFamily: "monospace", fontWeight: "600", color: "#1e293b", whiteSpace: "nowrap" }}>{val}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div style={{ display: "flex", flexDirection: "column", paddingTop: "4px" }}>
          <div style={{ fontSize: "0.76rem", fontWeight: "800", color: "#0f766e", marginBottom: "4px" }}>For Sanjhi Sikhiya Foundation</div>
          <div style={{ height: "60px", width: "200px" }}></div>
          <div style={{ height: "2px", background: "#000000", width: "200px" }}></div>
          <div style={{ fontSize: "0.68rem", color: "#64748b", marginTop: "4px" }}>Simranpreet singh oberoi</div>
          <div style={{ fontSize: "0.63rem", color: "#64748b", marginTop: "2px" }}>Co-Founder & CEO</div>
        </div>
